...
// })
 ...
 function updateLine(d, selectedOption) {
     ...
     var line = d3.line().x(function(d,i) {return x(d.letter);})
   ...
   .attr("cy", function(d,i){
     if(selectedOption == "preference"){return y(d.preference)}
     else if (selectedOption == "frequency"){return y(d.frequency)}
   })
 }
